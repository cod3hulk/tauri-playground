...
function App() {
  ...
  return (
    <main className="container">
      <h1>Combined Audio Recorder Visualization</h1>
      <p className="description">Captures Microphone & System Audio with real-time waveform visualization.</p>
